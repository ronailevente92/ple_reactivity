...
visu_ple_cfa <- ggplot(ple_cfa_figure) +
  geom_histogram(aes(ple_cfa), bins = 40, fill = "#A9A9A9", color = "#797979") +
  theme_classic() +
  labs(
    x = "PLE factor score",
    y = "Number of cases"
...
# distribution of log-transformed PLE CFA scores
ple_cfa_figure <- ple_cfa_figure %>% 
  mutate(ple_cfa_log = log10(ple_cfa + 3))

visu_ple_cfa_log <- ggplot(ple_cfa_figure) +
  geom_histogram(aes(ple_cfa_log), bins = 40, fill = "#A9A9A9", color = "#797979") +
  theme_classic() +
  labs(
    x = "PLE factor score (log10-transformed)",
    y = "Number of cases"
  ) +
  theme(axis.title = element_text(size = 12))
