...
```{r}
fit_formative <- lavaan::sem(sem_stressor_formative, data = dat, cluster = "id_esm", estimator = "ML")
```
...
```{r}
fit_formative_negaff <- lavaan::sem(stressor_formative_negaff, data = dat, cluster = "id_esm", estimator = "ML")
```
