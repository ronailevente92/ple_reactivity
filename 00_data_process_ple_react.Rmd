...
dat_cleaned <- 
  ...
  select(id_esm, session_esm, created_esm, age, gender, edu, city, start_date, date_esm, date_diary, three_day_block,
         ...
         contains(c("mss_", "ple_", "stressor", "dprime")), -contains(c("minutes")))
...
model_dat <-
  dat_cleaned %>%
  select(id_esm, session_esm, created_esm, edu, gender, age, city, start_date, date_diary, day, beep, diary_counter, three_day_block,
